...
static const uint32_t SHOW_EINS_DREI_ZEHN_HALB       = 0b11110000000 << 4;
static const uint32_t SHOW_ZWEI_VIER_FUENF_ACHT_NACH = 0b00000001111 << 4;
static const uint32_t SHOW_SECHS                     = 0b11111000000 << 4;
static const uint32_t SHOW_SIEBEN                    = 0b11111100000 << 4;
static const uint32_t SHOW_NEUN_FUNK                 = 0b00011110000 << 4;
...
void translate_time_to_led_positions(const HourAndMinute *hour_minute, uint32_t *t_rows_to_write) {
    ...
    if (minute < 25) {
        switch (hour) {
            ...
            case 1:
            case 13:
                t_rows_to_write[5] |= WORD_CLOCK_ROW_5 | SHOW_EINS_DREI_ZEHN_HALB;
                break;
            case 2:
            case 14:
                t_rows_to_write[5] |= WORD_CLOCK_ROW_5 | SHOW_ZWEI_VIER_FUENF_ACHT_NACH;
                break;
            case 3:
            case 15:
                t_rows_to_write[6] |= WORD_CLOCK_ROW_6 | SHOW_EINS_DREI_ZEHN_HALB;
                break;
            case 4:
            case 16:
                t_rows_to_write[6] |= WORD_CLOCK_ROW_6 | SHOW_ZWEI_VIER_FUENF_ACHT_NACH;
                break;
            case 5:
            case 17:
                t_rows_to_write[4] |= WORD_CLOCK_ROW_4 | SHOW_ZWEI_VIER_FUENF_ACHT_NACH;
                break;
            case 6:
            case 18:
            ...
            case 8:
            case 20:
                t_rows_to_write[7] |= WORD_CLOCK_ROW_7 | SHOW_ZWEI_VIER_FUENF_ACHT_NACH;
                break;
            case 9:
            case 21:
                t_rows_to_write[9] |= WORD_CLOCK_ROW_9 | SHOW_NEUN_FUNK;
                break;
            case 10:
            case 22:
                t_rows_to_write[9] |= WORD_CLOCK_ROW_9 | SHOW_EINS_DREI_ZEHN_HALB;
                break;
            case 11:
            case 23:
    ...
    for (uint8_t row = 0; row < WORD_CLOCK_MAX_ROWS; ++row) {
        const uint32_t correct_led_binary = (t_rows_to_write[row] & ROW_MASK) | (
                                                ~t_rows_to_write[row] & COLUMN_MINUTE_MASK);
